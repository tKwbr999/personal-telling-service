    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="container mx-auto flex-grow px-4 py-8 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
          <h1 className="text-2xl font-bold text-center text-gray-900 mb-6">新規登録</h1>
          ...
          <div className="mt-6 mb-4">
            <div className="relative flex items-center">
              ...
              <span className="flex-shrink mx-4 text-gray-600 text-sm">登録について</span>
              <div className="flex-grow border-t border-gray-300"></div>
            </div>
          </div>
          ...
          <div className="bg-indigo-50 p-4 rounded-md text-sm text-indigo-800">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>当サービスでは、Google認証によるログインのみをサポートしています。</li>
              <li>登録には有効なGoogleアカウントが必要です。</li>
              <li>お客様の個人情報は厳重に保護され、鑑定目的以外には使用されません。</li>
            </ul>
          </div>
